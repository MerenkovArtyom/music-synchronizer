...
type BackendEnvelope<T> =
  | { ok: true; command: "show-config" | "sync" | "dashboard" | "list" | "top-listen" | "recommend"; data: T }
  | { ok: false; command: "show-config" | "sync" | "dashboard" | "list" | "top-listen" | "recommend"; error: { code: string; message: string; details: Record<string, unknown> } };
```
