...
type BackendEnvelope<T> =
  | { ok: true; command: "show-config" | "sync" | "dashboard" | "list" | "top-listen"; data: T }
  | { ok: false; command: "show-config" | "sync" | "dashboard" | "list" | "top-listen"; error: { code: string; message: string; details: Record<string, unknown> } };
```
